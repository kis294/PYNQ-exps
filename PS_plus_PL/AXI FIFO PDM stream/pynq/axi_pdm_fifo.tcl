...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set M00_CLK [ create_bd_port -dir O M00_CLK ]
  set M00_DATA [ create_bd_port -dir I M00_DATA ]
  set M00_LRSEL [ create_bd_port -dir O M00_LRSEL ]
  ...
  set block_name pdm_microphone
  set block_cell_name pdm_microphone_0
  if { [catch {set pdm_microphone_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pdm_microphone_0 eq "" } {
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins processing_system7_0/S_AXI_HP1] [get_bd_intf_pins smartconnect_1/M01_AXI]
  ...
  connect_bd_net -net M00_DATA_1 [get_bd_ports M00_DATA] [get_bd_pins pdm_microphone_0/M_DATA]
  connect_bd_net -net cic_compiler_0_m_axis_data_tdata [get_bd_pins cic_compiler_0/m_axis_data_tdata] [get_bd_pins tlast_gen_0/s_axis_tdata]
  connect_bd_net -net cic_compiler_0_m_axis_data_tvalid [get_bd_pins cic_compiler_0/m_axis_data_tvalid] [get_bd_pins tlast_gen_0/s_axis_tvalid]
  connect_bd_net -net pdm_microphone_0_M_LRSEL [get_bd_ports M00_LRSEL] [get_bd_pins pdm_microphone_0/M_LRSEL]
  connect_bd_net -net pdm_microphone_0_m_clk [get_bd_ports M00_CLK] [get_bd_pins pdm_microphone_0/m_clk]
  connect_bd_net -net pdm_microphone_0_mic_data [get_bd_pins cic_compiler_0/s_axis_data_tdata] [get_bd_pins pdm_microphone_0/mic_data]
  connect_bd_net -net pdm_microphone_0_mic_data_valid [get_bd_pins cic_compiler_0/s_axis_data_tvalid] [get_bd_pins pdm_microphone_0/mic_data_valid] [get_bd_pins system_ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets pdm_microphone_0_mic_data_valid]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins pdm_microphone_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins tlast_gen_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins pdm_microphone_0/rst] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins tlast_gen_0/resetn]
